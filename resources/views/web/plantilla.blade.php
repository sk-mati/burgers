...
<body class="sub_page">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="user_option">
              ...
              <a href="/carrito" class="cart_link">
                ...
                <span class="position-relative translate-middle badge rounded-pill text-bg-dark">
                  {{ $total }}
                </span>
              </a>
  ...
  <footer class="footer_section">
    ...
    <div class="footer-info">
        <p>
          <h6><i class="fa fa-envelope" aria-hidden="true"></i><a href="*" class="order-online"> burgers@email.com</a></h6>
          <br>
